...
public:
  LocalAwarePacketQueue(int max_entries);
...
class LocalAwarePacketManager : public mesh::PacketManager {
  LocalAwarePacketQueue unused, send_queue, rx_queue;
  MyMesh *_mesh;

public:
  LocalAwarePacketManager(int pool_size, MyMesh *mesh);
